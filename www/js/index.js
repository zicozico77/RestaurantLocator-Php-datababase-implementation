...
function addMarkers(themap) {
    ...
    var icons = {
        Bar: {
            icon: 'https://infs3202-xes2q.uqcloud.net/Project/images/bar.png'
        },
        Restaurant: {
            icon: 'https://infs3202-xes2q.uqcloud.net/Project/images/Restaurant.png'
        },
        Cafe: {
            icon: 'https://infs3202-xes2q.uqcloud.net/Project/images/cafe.png'
        }
    };
                        ...
                        xmlhttpdeals.onreadystatechange = function() {
                            if (this.readyState == 4 && this.status == 200) {
                                ...
                                for (var i = 0; i < deals.length; i++) {
                                    ...
                                    printdeals += "<li><div>" + dealtext + "</div>" +startdate + "<div> to </div>" + enddate + "</li>"
                                }
...
'<p style="text-align: center;"><strong>CONTACT</strong></p><p style="text-align: center;">' + data.phone + '</p><p style="text-align: center;">' + data.email + '</p>'
                        ...
                        xmlhttpdeals.open("GET", "https://infs3202-xes2q.uqcloud.net/Project/deals_pull.php?id=" + user_id, true);
                        xmlhttpdeals.send();
    ...
    xmlhttp.open("GET", "https://infs3202-xes2q.uqcloud.net/Project/map_db_pull.php?swLat=" + swLat + "&swLng=" + swLng + "&neLat=" + neLat + "&neLng=" + neLng + "&cLat=" + cLat + "&cLng=" + cLng + "&bar=" + bar + "&cafe=" + cafe + "&restaurant=" + restaurant + "&date=" + date, true);
    xmlhttp.send();
